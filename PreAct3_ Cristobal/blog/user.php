...
if(isset($_POST['submit'])) {
    ...
    $sql = "insert into `data` (username,password,firstname,lastname,age,birthday,address)
...
<html lang="en">
  ...
  <h1>Sign Up</h1>
   ...
   <div class="form-floating">
    ...
    <input type="text" class="form-control" id="floatingInput" placeholder="Please enter username" name="username" autocomplete = "off">
</div>
<div class="form-floating">
    <label for="floatingInput" >Password</label>
    <input type="text" class="form-control" id="floatingInput" placeholder="enter password" name="password" autocomplete = "off">
</div>
  <div class="form-floating">
