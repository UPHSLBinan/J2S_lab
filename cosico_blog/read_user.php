...
$row = mysqli_fetch_assoc($result);
    ...
    <div class="d-flex justify-content-between align-items-center">
     <button class="btn btn-primary"><a href="update.php?updt_user=<?php echo $_SESSION['username']; ?>" style="text-decoration:none" class="text-white">Update</a></button>
  <button class="btn btn-danger" name back><a href="user_blog.php" style="text-decoration:none" class="text-white">Back</a></button>
