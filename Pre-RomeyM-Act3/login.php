...
<?php } ?>
    ...
    <div>
        ...
        <input type="text" name="username" placeholder="Your Username" style="border-radius: 5px; border: 0.1px solid gray; padding: 5px; margin: 10px; width: 50%;" required>
    </div>
    <div>
       <label for="password" style="font-weight: bold;">Password:</label>
        <input type="password" name="password" placeholder="Your Password" style="border-radius: 5px; border: 0.1px solid gray; padding: 5px; margin: 10px; width: 50%;" required>
    </div>
    <div>
        <br><button type="submit" style="background-color: #ffc451ff; border-radius: 5px; border: 0px; padding: 10px; width: 20%;">Login</button>
    </div>
<br>
    <div>
